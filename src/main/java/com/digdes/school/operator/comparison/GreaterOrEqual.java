...
public class GreaterOrEqual<T extends Type, U extends Type> extends ComparisonOperatorBase<T, U> {

    public GreaterOrEqual() {
        super(ComparisonOperator.GREATER_OR_EQUAL);
    }
    ...
    public boolean test(T t, U u) {
        ...
        throw new TypeErrorException(String.format("greater or equal not number: %s >= %s",
